...
router.post('/sendForgotMail', upload.any(),  function(req, res, next){
	...
	if(err){
		...
		let mailOptions = {
			...
			text: "Hey " + name + " reset you password here http://www.blast.imajin.media/#!/setPassword?tkn=" + new_token,
			html: "Hey " + name + " you can <a href='http://www.blast.imajin.media/#!/setPassword/" + new_token + "'>rest your password here</a>" + "\n\n" +
